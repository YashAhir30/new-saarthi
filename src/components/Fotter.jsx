...
const FacebookIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 320 512" fill="currentColor">
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: 'clamp(60px,8vw,100px) clamp(20px,5vw,60px) clamp(32px,4vw,48px)', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '40px 60px', marginBottom: '60px' }}>
          ...
          <div style={{ gridColumn: 'span 1' }}>
            <img src="./src/assets/logo.png" alt="Saarthi Homeopathy" style={{ height: '48px', marginBottom: '20px' }} />
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              ...
              <SocialBtn href="https://www.facebook.com/" icon={FacebookIcon} label="Facebook" />
            </div>
          </div>
